...
ToggleCPHKey          := "+Right" ; Toggle Cayo Perico Heist Final mode (extra menu entry), also see DoToggleCPHWithVIP
...
IntPhoneMenuDelay := 1500 ; delay (in ms) after opening phone menu.
...
IntKeyPressDuration := 10 ; duration (in ms) each key press is held down.
...
#IfWinActive ahk_class grcWindow
  ...
  return
  BuyOtherAmmoType:
    Send {Up}{Up}{Right} {Down}{Down} {Enter}
    sleep, IntPhoneMenuDelay
  return
